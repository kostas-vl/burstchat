...
CREATE TABLE sippeers (
    ...
    subscribemwi boolean, 
    vmexten VARCHAR(40), 
    autoframing boolean, 
    rtpkeepalive INTEGER, 
    "call-limit" INTEGER, 
    g726nonstandard boolean, 
    ignoresdpversion boolean, 
...
CREATE TABLE iaxfriends (
    ...
    forcejitterbuffer boolean, 
    disallow VARCHAR(200), 
    allow VARCHAR(200), 
    codecpriority VARCHAR(40), 
    qualify VARCHAR(10), 
    qualifysmoothing boolean, 
...
ALTER TABLE ps_aors ADD COLUMN support_path boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN force_avp boolean;

ALTER TABLE ps_endpoints ADD COLUMN media_use_received_transport boolean;
...
ALTER TABLE ps_transports ALTER COLUMN verifiy_server TYPE boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN user_eq_phone boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN moh_passthrough boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN media_encryption_optimistic boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN rpid_immediate boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN g726_non_standard boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN bind_rtp_to_media_address boolean;
...
ALTER TABLE ps_systems ADD COLUMN disable_tcp_switch boolean;

ALTER TABLE ps_registrations ADD COLUMN line boolean;
...
ALTER TABLE ps_transports ADD COLUMN allow_reload boolean;
...
ALTER TABLE ps_globals ADD COLUMN disable_multi_domain boolean;
...
ALTER TABLE ps_contacts ADD COLUMN authenticate_qualify boolean;
...
ALTER TABLE ps_globals ADD COLUMN mwi_disable_initial_unsolicited boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN preferred_codec_only boolean;
...
ALTER TABLE ps_globals ADD COLUMN ignore_uri_user_options boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN asymmetric_rtp_codec boolean;
...
ALTER TABLE ps_endpoint_id_ips ADD COLUMN srv_lookups boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN rtcp_mux boolean;
...
ALTER TABLE ps_transports ADD COLUMN symmetric_transport boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN allow_overlap boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN refer_blind_progress boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN notify_early_inuse_ringing boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN webrtc boolean;
...
ALTER TABLE ps_contacts ADD COLUMN prune_on_boot boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN bundle boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN dtls_auto_generate_cert boolean;
...
ALTER TABLE ps_subscription_persistence ADD COLUMN prune_on_boot boolean;
...
ALTER TABLE ps_systems ADD COLUMN follow_early_media_fork boolean;

ALTER TABLE ps_systems ADD COLUMN accept_multiple_sdp_answers boolean;

ALTER TABLE ps_endpoints ADD COLUMN follow_early_media_fork boolean;

ALTER TABLE ps_endpoints ADD COLUMN accept_multiple_sdp_answers boolean;
...
ALTER TABLE ps_endpoints ADD COLUMN suppress_q850_reason_header boolean;
...
ALTER TABLE ps_endpoints ALTER COLUMN suppress_q850_reason_header TYPE boolean;
